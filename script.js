...
function drawWinLine(combo) {
    ...
    requestAnimationFrame(() => {
        ...
        // 使用中心點定位和旋轉，處理對角線和直線的複雜性
        const centerCell = cells[combo[1]].getBoundingClientRect();
        const centerX = centerCell.left + centerCell.width / 2 - boardRect.left;
        const centerY = centerCell.top + centerCell.height / 2 - boardRect.top;
